...
class _EmergencyScreenState extends State<EmergencyScreen> {
  ...
  List<EmergencyService> get _filteredServices {
    if (_searchQuery.isEmpty) {
      return AppData.emergencyServices;
    }
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            _buildSearchBar(),
            Expanded(
              child: _buildEmergencyServicesGrid(),
            ),
          ],
        ),
      ),
...
class _EmergencyServiceCard extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: AppColors.errorRed.withOpacity(0.7)),
        ),
        elevation: 0.1,
        child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            service.area ?? _getServiceTypeLabel(service.type),
                            style: const TextStyle(
                              fontSize: 12,
                              color: Colors.grey,
                            ),
  ...
  IconData _getServiceIcon(EmergencyServiceType type) {
    switch (type) {
  ...
  String _getServiceTypeLabel(EmergencyServiceType type) {
    switch (type) {
      case EmergencyServiceType.towing:
        return 'ونش';
      case EmergencyServiceType.fuel:
